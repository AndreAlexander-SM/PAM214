...
50% más el jefe de grupo, es vigente para todo alumno inscrito en el curso aunque no esté presente en la primera sesión.");   
    ...
    public static void LineamentosClassroom() {
        
        JOptionPane.showMessageDialog(null, "El reglamento");
    }
    ...
    public static void PorcentajesporParcial() {
        ...
        JOptionPane.showMessageDialog(null, "Porcentajes");
    }
